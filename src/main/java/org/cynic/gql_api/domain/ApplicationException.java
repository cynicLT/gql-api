package org.cynic.gql_api.domain;
...
public final class ApplicationException extends RuntimeException {
    ...
    @SafeVarargs
    public ApplicationException(String code, Throwable e, Map.Entry<String, Object>... values) {
        this(code,
            e,
    ...
    @SafeVarargs
    public ApplicationException(final String code, final Map.Entry<String, Object>... values) {
